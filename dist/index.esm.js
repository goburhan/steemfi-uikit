...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/Metavill1.svg" })));
};
...
var StyledToggle = styled.div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  align-items: flex-start;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 40px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 72px;\n"], ["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 40px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 72px;\n"])), function (_a) {
    ...
    return theme.colors[checked ? "toggle1" : "toggle2"];
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.inset;
});
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 155 56" }, props),
        React.createElement("image", { width: "155", height: "55", href: isDark ? "/images/mainlogo.svg" : "/images/mainlogo.svg" })))
};
...
var TopMenuEntry = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content : center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background : ", ";\n  \n  color: ", ";\n  box-shadow: ", ";\n \n border:1px solid transparent; border-radius:5px;   width: 120px;\n  a {\n    display: flex;\n    align-items: center;\n    justify-content : center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content : center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background : ", ";\n  \n  color: ", ";\n  box-shadow: ", ";\n  width: 120px;\n  a {\n    display: flex;\n    align-items: center;\n    justify-content : center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    var secondary = _a.secondary;
    return (secondary ? "0 42px" : "0 0px");
}, function (_a) {
    var secondary = _a.secondary;
    return (secondary ? "14px" : "16px");
}, function (_a) {
    ...
    var isActive = _a.isActive, theme = _a.theme;
    return (isActive ? "inset 0px -2px 0px " + "rgba(58, 122, 135,0.5)" : "none");
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
}, function (_a) {
...
var AccordionContent$1 = styled.div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  max-height: ", ";\n  &:hover {\n    ", ";\n  }\n  position:absolute;\n  top:100;\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  border-bottom-radius : 6px;\n  width : 120px;\n"], ["\n  max-height: ", ";\n  &:hover {\n    ", ";\n  }\n  position:absolute;\n  top:100;\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  border-bottom-radius : 6px;\n  width : 120px;\n"])), function (_a) {
    ...
    var isOpen = _a.isOpen, isPushed = _a.isPushed;
    return (isOpen && isPushed ? "rgba(133, 133, 133, 1)" : "none");
});
var Accordion$1 = function (_a) {
    ...
    return (React.createElement(Container$5, null,
        React.createElement(TopMenuEntry, { onClick: handleClick, className: className, onMouseOver: function () { return setActiveAccordion(label); }, onMouseLeave: function () { return setActiveAccordion(''); } },
            ...
            isOpen ? React.createElement(Icon$8, null) : React.createElement(Icon$7, null)),                                //top menu dropdown backgorund
        React.createElement(AccordionContent$1, { onMouseOver: function () { return setActiveAccordion(label);  }, style: { background :"rgba(30,30,30,0.5)"  } , onMouseLeave: function () { return setActiveAccordion(''); }, isOpen: activeAccordion === label, isPushed: isPushed, maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT }, children ) ) );
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "white", background: "#1E2225", backgroundDisabled: "#3c3742", contrast: "#E6F8F1", invertedContrast: "#191326", input: "#fff", toggle1:"#eb0c29", toggle2:"#fff", primaryDark: "#0098A1", tertiary: "rgba(255,255,255,0.45)", text: "#fff", textDisabled: "#666171", textSubtle: "#fff",inactive:"#524B63" , borderColor: "#524B63", card: "transparent", white: '#FFFFFF',calloptionbutton:"#ffffB3" ,gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#1E2225", backgroundDisabled: "#3c3742", contrast: "#E6F8F1", invertedContrast: "#191326", input: "#d6cda3", primaryDark: "#0098A1", tertiary: "#FEECE9", text: "#E6F8F1", textDisabled: "#666171", textSubtle: "#2EB086", borderColor: "#524B63", card: "transparent", white: '#FFFFFF', gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
...
var light$1 = (_a$2 = {},
    ...
    _a$2[SUBTLE] = {
        ...
        backgroundActive: lightColors.inactive + "D9",
        backgroundHover: lightColors.inactive + "B3",
        border: 0,
        borderColorHover: "currentColor",
        boxShadow: "none",
        boxShadowActive: "none",
